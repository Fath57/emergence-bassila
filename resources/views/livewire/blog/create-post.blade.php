<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        <h1 class="text-2xl font-bold text-[#333333] mb-6">Rédiger un article</h1>
        ...
        <form wire:submit.prevent="save" class="space-y-5">
            ...
            <div>
                ...
                @if ($featuredImage)
                    <img src="{{ $featuredImage->temporaryUrl() }}" class="mb-2 h-40 w-full object-cover rounded-lg" alt="Aperçu">
                @endif
                <input
            ...
            <!-- Excerpt -->
            <div>
                <label for="excerpt" class="block text-sm font-medium text-gray-700 mb-1">Extrait <span class="text-gray-400">(optionnel)</span></label>
                <textarea
                    wire:model="excerpt"
                    id="excerpt"
                    rows="2"
            ...
            <div class="flex gap-3 pt-2">
                ...
                >
                    <span wire:loading.remove>Publier l'article</span>
                    <span wire:loading>Publication...</span>
                </button>
                <a href="{{ route('blog.index') }}" class="px-4 py-2.5 rounded-lg border border-gray-300 text-sm text-gray-600 hover:bg-gray-50 transition" wire:navigate>
                    Annuler
                </a>
            </div>
        </form>
