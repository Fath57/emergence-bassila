...
@section('description', 'Modifier un article du blog Bassila Émergence.')
@push('head')
...
<div class="max-w-4xl mx-auto px-5 py-10">
    ...
    <div class="flex items-center justify-between flex-wrap gap-3 mb-8">
        <div>
            <h1 class="font-serif text-3xl md:text-4xl font-semibold text-[#0A1628]">Modifier l'article</h1>
            @if ($autoSavedAt)
    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div>
            ...
            <div class="flex items-stretch border border-gray-300 @error('slug') border-red-400 @enderror">
                ...
                <input wire:model="slug" id="slug" type="text" class="flex-1 px-3 py-2 text-sm focus:outline-none">
            </div>
        ...
        <div>
            ...
            @if ($featuredImage)
                <img src="{{ $featuredImage->temporaryUrl() }}" class="mb-3 h-48 w-full object-cover border-2 border-[#0066CC]" alt="Nouvelle image">
        ...
        {{-- SEO panel --}}
        <details class="border border-gray-200" @if ($metaTitle || $metaDescription) open @endif>
            ...
            <div class="p-4 space-y-4">
                <div>
                    ...
                    <input wire:model="metaTitle" id="metaTitle" type="text" maxlength="70"
                ...
                <div>
                    ...
                    <textarea wire:model="metaDescription" id="metaDescription" rows="2" maxlength="160"
