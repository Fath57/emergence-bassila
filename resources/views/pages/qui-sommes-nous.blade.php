...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <section class="prose prose-lg max-w-none mb-12 anim-reveal">
        <h2>Notre mission</h2>
        <p>
    ...
    <section class="mb-12 anim-reveal">
        ...
        <div class="grid md:grid-cols-2 gap-6 anim-reveal-stagger">
            ...
            <div class="border border-gray-200 p-6 hover-lift" style="--i: 1;">
            ...
            <div class="border border-gray-200 p-6 hover-lift" style="--i: 2;">
            ...
            <div class="border border-gray-200 p-6 hover-lift" style="--i: 3;">
