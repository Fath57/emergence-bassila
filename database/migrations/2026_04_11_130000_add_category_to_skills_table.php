...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('skills', function (Blueprint $table) {
            ...
            $table->smallInteger('sort_order')->default(0)->after('category');
            $table->index('category', 'idx_skills_category');
        });

        // Backfill categories from the original SkillSeeder taxonomy
        foreach (self::taxonomy() as $category => $names) {
