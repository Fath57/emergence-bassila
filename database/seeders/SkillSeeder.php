...
class SkillSeeder extends Seeder
{
    public function run(): void
    {
        $taxonomy = [
            ...
            'Métiers & Services' => [
                'Menuiserie', 'Maçonnerie', 'Électricité bâtiment',
                'Électricité industrielle', 'Plomberie & Sanitaire',
                'Vulcanisation & Réparation pneumatiques',
                'Mécanique automobile', 'Soudure & Métallerie',
                'Peinture bâtiment', 'Carrelage & Revêtement',
                'Climatisation & Froid', 'Couture & Confection',
                'Coiffure & Esthétique',
                'Transport & Mobilité',
